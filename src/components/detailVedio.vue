...
<script lang="ts" setup name="detailVideo">
import detailHrader from './detailHrader.vue'
...
import detailVideoSrc from './detailVideoSrc.vue'
...
onMounted(() => {
  ...
  if (id) {
    detailVideoStore.getdetailvideo(id)
  }
})
</script>
